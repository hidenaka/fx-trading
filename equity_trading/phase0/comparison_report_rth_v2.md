...
| Symbol | Params | Trades | Wins | Win Rate | Avg P&L | Expected (P&L×Count) |
|--------|--------|--------|------|----------|---------|----------------------|
| SPY | `{"_max_hold_bars": 1, "entry_signal_bar": 76}` | 1747 | 833 | 0.477 | -0.070% | -122.42 |
| QQQ | `{"_max_hold_bars": 1, "entry_signal_bar": 76}` | 1747 | 842 | 0.482 | -0.058% | -101.53 |
| IWM | `{"_max_hold_bars": 1, "entry_signal_bar": 76}` | 1742 | 844 | 0.485 | -0.046% | -79.74 |
| DIA | `{"_max_hold_bars": 1, "entry_signal_bar": 76}` | 1739 | 790 | 0.454 | -0.077% | -133.76 |
| XLK | `{"_max_hold_bars": 1, "entry_signal_bar": 76}` | 1739 | 866 | 0.498 | -0.082% | -143.11 |

**Best for overnight_hold:** IWM / `{"_max_hold_bars": 1, "entry_signal_bar": 76}` → EV -79.74 (WR 0.485, Trades 1742)
...
| 12 | overnight_hold | IWM | `{"_max_hold_bars": 1, "entry_signal_bar": 76}` | -79.74 | 0.485 | 1742 |
| 13 | trend_follow | IWM | `{"breakout_period": 50, "rsi_threshold": 55.0}` | -133.29 | 0.408 | 1641 |
